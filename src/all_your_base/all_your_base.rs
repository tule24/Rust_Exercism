...
pub fn convert(number: &[u32], from_base: u32, to_base: u32) -> Result<Vec<u32>, Error> {
    ...
    // number.reverse();
    // for (i, v) in number.into_iter().enumerate(){
    //     if v >= from_base {return Err(Error::InvalidDigit(v))}
    //     temp += v*(from_base.pow(i as u32));
    // }
